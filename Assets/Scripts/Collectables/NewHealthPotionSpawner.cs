...
//public class NewHealthPotionSpawner : MonoBehaviour
//{
...
//    public int maxPotions = 10; // Maximum number of pearls allowed in the scene at one time
//    public float minDistFromPlayer = 5f; // Minimum distance from the player to spawn pearls
//    public float minDistFromOtherPotions = 10f; // Minimum distance from other pearls to spawn a new one
